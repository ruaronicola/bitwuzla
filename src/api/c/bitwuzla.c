...
static BzlaOption bzla_options[BITWUZLA_OPT_NUM_OPTS] = {
    ...
    [BITWUZLA_OPT_QUANT_CER]                = BZLA_OPT_QUANT_CER,
    [BITWUZLA_OPT_QUANT_DER]                = BZLA_OPT_QUANT_DER,
    [BITWUZLA_OPT_QUANT_DUAL_SOLVER]        = BZLA_OPT_QUANT_DUAL_SOLVER,
    [BITWUZLA_OPT_QUANT_FIXSYNTH]           = BZLA_OPT_QUANT_FIXSYNTH,
    [BITWUZLA_OPT_QUANT_MINISCOPE]          = BZLA_OPT_QUANT_MINISCOPE,
    [BITWUZLA_OPT_QUANT_SYNTH]              = BZLA_OPT_QUANT_SYNTH,
    [BITWUZLA_OPT_QUANT_SYNTH_ITE_COMPLETE] = BZLA_OPT_QUANT_SYNTH_ITE_COMPLETE,
    [BITWUZLA_OPT_QUANT_SYNTH_LIMIT]        = BZLA_OPT_QUANT_SYNTH_LIMIT,
